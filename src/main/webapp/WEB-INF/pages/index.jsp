    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <form class="navbar-form navbar-left" role="search" action="/search" method="post">
                            ...
                            <a href="/export/csv" class="btn btn-default">Export to CSV</a>
                            <button id="export_selected" class="btn btn-default" onclick="exportSelectedContacts()">Export Selected to CSV</button>
        ...
        <script>
            ...
            function exportSelectedContacts() {
                var data = { 'toExport[]' : [] };
                $(":checked").each(function() {
                    data['toExport[]'].push($(this).val());
                });

                $.post("/contact/export", data)
                    .done(function(csvContent) {
                        var blob = new Blob([csvContent], { type: 'text/csv' });
                        var link = document.createElement('a');
                        link.href = window.URL.createObjectURL(blob);
                        link.download = 'selected_contacts.csv';
                        link.click();
                    })
